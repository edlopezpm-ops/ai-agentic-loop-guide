...
Local HTML5 showcase for Ed Lopez's Salesforce Solution Engineer interview.
...
The working loop is documented in `CODEX.MD`:

Design -> Execute -> Review -> Validate -> Deliver.
